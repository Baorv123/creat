...
ImageButton.Image = "rbxassetid://100777950976214"
...
if World1 then
    Dropdown = Tele:AddDropdown("Dropdown", {
        Title = "Select Island",
        Values = {
...
Toggle = Tele:AddToggle("Toggle", {Title = "Teleport Island", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Sub:AddToggle("Toggle", {Title = "Auto Quest Dojo Trainer", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Sub:AddToggle("Toggle", {Title = "Auto Upgrade Dragon Talon", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Sub:AddToggle("Toggle", {Title = "Auto Attack Hydra Mob And Collect Ember", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Sub:AddToggle("Toggle", {Title = "Auto Collect FireFlower", Default = false })
Toggle:OnChanged(function(Value)
...
ToggleChest = Sub:AddToggle("ToggleChest", {Title = "Auto Chest", Default = false })
...
Toggle = Sub:AddToggle("Toggle", {Title = "Stop When Have God's Chalice& Fist Of Darkness", Default = false })
Toggle:OnChanged(function(Value)
...
ObservationRange = Sub:AddParagraph({
...
Toggle = Sub:AddToggle("Toggle", {Title = "Auto UP Observation V2", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Sub:AddToggle("Toggle", {Title = "Farm Observation", Default = false })
Toggle:OnChanged(function(Value)
...
Dropdown = Sub:AddDropdown("Dropdown", {
    Title = "Select Boss",
    Values = tableBoss,
    Multi = false,
})
...
Toggle = Sub:AddToggle("Toggle", {Title = "Auto Kill Boss", Default = getgenv().AutoFarmBoss })
Toggle:OnChanged(function(Value)
...
Toggle = Sub:AddToggle("Toggle", {Title = "Auto Kill All Boss", Default = false })
Toggle:OnChanged(function(Value)    
...
Toggle = Fruit:AddToggle("Toggle", {Title = "Random Devil Fruit", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Fruit:AddToggle("Toggle", {Title = "Auto Store Fruit", Default = false })
Toggle:OnChanged(function(Value)
...
Dropdown = Fruit:AddDropdown("Dropdown", {
...
Toggle = Fruit:AddToggle("Toggle", {Title = "Buy Blox Fruit Sniper Shop", Default = false })
Toggle:OnChanged(function(Value)
...
Dropdown = Raid:AddDropdown("Dropdown", {
    Title = "Select Raid",
    Values = {
...
Toggle = Raid:AddToggle("Toggle", {Title = "Get Fruit In Inventory Low Beli", Default = false})
Toggle:OnChanged(function(Value)
...
Toggle = Raid:AddToggle("Toggle", {Title = "Auto Raid", Default = false})
Toggle:OnChanged(function(Value)
...
Toggle = Raid:AddToggle("Toggle", {Title = "Auto Awaken Fruit", Default = false})
Toggle:OnChanged(function(Value)
